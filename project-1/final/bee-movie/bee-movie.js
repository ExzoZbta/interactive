document.addEventListener("DOMContentLoaded", function() {
    ...
    var initialStartContent = document.getElementById('start').innerHTML;
    var initialFifteenMinContent = document.getElementById('fifteen-min').innerHTML;
    var initialThirtyMinContent = document.getElementById('thirty-min').innerHTML;
    var initialFourtyfiveMinContent = document.getElementById('fortyfive-min').innerHTML;
    var initialHourContent = document.getElementById('hour-min').innerHTML;
    var initialSeventyfiveContent = document.getElementById('seventyfive-min').innerHTML;
    var initialEndContent = document.getElementById('end').innerHTML;
    ...
    // print the Bee Movie script instantly
    function printScript(outputDiv, additionalHTML) {
        var tempDiv = document.createElement('div');
        tempDiv.innerHTML = additionalHTML;
        var children = tempDiv.childNodes;
        children.forEach(function(child, index) {
    ...
    function submitCommand(event) {
        ...
        if (!event || event.keyCode === 13 || event.type === 'click') {
            ...
            // display list of commands
               ...
               "\necho script - Displays the entire script of the 'Bee Movie.'" +
               "\ncl_cursor_file bee_cursor - Changes the appearance of the cursor." +
               "\nrs_time [X:XX:XX] - Displays a portion of the script at a specific time." +
            ...
            // print script text
            } else if (commandText === 'echo script') {
                printCommand(document.querySelector('.text-container'), commandText);

                var additionalText = "Loading script...........";
                printAdditionalText(document.querySelector('.text-container'), additionalText);

                setTimeout(function() {
                    printScript(document.querySelector('.text-container'), initialTextContainer1HTMLContent);
                }, 1800); 

            // change cursor to a bee
            } else if (commandText === 'cl_cursor_file bee_cursor') {
                printCommand(document.querySelector('.text-container'), commandText);
                
                var additionalText = "Your cursor is changing to Barry B. Benson.......";
                printAdditionalText(document.querySelector('.text-container'), additionalText);
            ...
            // print start mark of text
            } else if (commandText === 'rs_time start') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialStartContent);
                }, 850);

            // print 15 min mark of text
            } else if (commandText === 'rs_time 0:15:00') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialFifteenMinContent);
                }, 850);

            // print 30 min mark of text
            } else if (commandText === 'rs_time 0:30:00') {
                printCommand(document.querySelector('.text-container'), commandText);
                
                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialThirtyMinContent);
                }, 850);

            // print 45 mark of text
            } else if (commandText === 'rs_time 0:45:00') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialFourtyfiveMinContent);
                }, 850);

            // print 60 mark of text
            } else if (commandText === 'rs_time 1:00:00') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialHourContent);
                }, 850);

            // print 75 mark of text
            } else if (commandText === 'rs_time 1:15:00') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialSeventyfiveContent);
                }, 850);

            // print end of text
            } else if (commandText === 'rs_time end') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialEndContent);
                }, 850);
