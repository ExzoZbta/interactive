    ...
    function submitCommand(event) {
        ...
        if (!event || event.keyCode === 13 || event.type === 'click') {
            ...
            // display list of commands
               ...
               "\necho speech - Displays the text version of the 'Collaboration' speech by Dr. Wallace Breen, Earth's Adminstrator and the World's Most Hated Man." +
               "\nent_create gnome - Summons Gnome Chompski." +
               "\nplaysound the_administrator - Plays the audio (and full) version of the 'Collaboration' speech by Dr. Wallace Breen";
            ...
            // print speech text
            } else if (commandText === 'echo speech') {
                printCommand(document.querySelector('.text-container'), commandText);
