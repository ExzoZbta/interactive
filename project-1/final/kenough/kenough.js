document.addEventListener("DOMContentLoaded", function() {
    ...
    var initialVerse1HTMLContent = document.getElementById('verse1').innerHTML;
    var initialChorus1HTMLContent = document.getElementById('chorus1').innerHTML;
    var initialVerse2HTMLContent = document.getElementById('verse2').innerHTML;
    var initialBridgeHTMLContent = document.getElementById('bridge').innerHTML;
    var initialChorus2HTMLContent = document.getElementById('chorus2').innerHTML;
    var initialOutroHTMLContent = document.getElementById('outro').innerHTML;
    var initialFullSongHTMLContent = document.getElementById('full-song').innerHTML;
    ...
    function submitCommand(event) {
        ...
        if (!event || event.keyCode === 13 || event.type === 'click') {
            ...
            // display list of commands
               ...
               "\necho [song portion] - Displays a specific portion of 'I'm Just Ken'" +
               "\n==List of song portions: " +
               "\n----full_song" +
               "\n----verse_1" +
               "\n----chorus_1" +
               "\n----verse_2" +
            ...
            // print full song text
            } else if (commandText === 'echo full_song') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialFullSongHTMLContent);
                }, 1000);

            // print verse 1 text
            } else if (commandText === 'echo verse_1') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialVerse1HTMLContent);
                }, 2000);
            
            // print chorus 1 text
            } else if (commandText === 'echo chorus_1') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialChorus1HTMLContent);
                }, 2000); 
            
            // print verse 2 text
            } else if (commandText === 'echo verse_2') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialVerse2HTMLContent);
                }, 2000); 

            // print bridge text
            } else if (commandText === 'echo bridge') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialBridgeHTMLContent);
                }, 2000); 

            // print chorus 2 text
            } else if (commandText === 'echo chorus_2') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialChorus2HTMLContent);
                }, 2000); 

            // print outro text
            } else if (commandText === 'echo outro') {
                printCommand(document.querySelector('.text-container'), commandText);

                setTimeout(function() {
                    printAdditionalHTML(document.querySelector('.text-container'), initialOutroHTMLContent);
                }, 2000); 

            // play ken audio
            } else if (commandText === 'playsound im_ken') {
                printCommand(document.querySelector('.text-container'), commandText);
                ...
                setTimeout(function() {
                    var kenAudio = document.getElementById('ken-audio');
                    kenAudio.play();
                }, 3500);
