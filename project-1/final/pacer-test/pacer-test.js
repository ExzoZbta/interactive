    ...
    function submitCommand(event) {
        ...
        if (!event || event.keyCode === 13 || event.type === 'click') {
            ...
            // display list of commands
               ...
               "\necho pacer_test - Displays the text of the introduction of the procedures and expectations of the FitnessGram™ Pacer Test." +
               "\nplaysound pacer_intro - Plays the introduction of the procedures and expectations of the FitnessGram™ Pacer Test.";
            ...
            // print info about the current page
                ...
                // accelerate everything in the page-container from right to left
            // } else if (commandText === 'sv_accelerate 1') {
            //     printCommand(document.querySelector('.text-container'), commandText);
                
            //     var additionalText = "Accelerating...";
            //     printAdditionalText(document.querySelector('.text-container'), additionalText);

            //     // Apply the animation to the page-container
            //     var pageContainer = document.querySelector('.page-container');
            //     pageContainer.style.animation = 'accelerate 5s linear infinite';

            // print speech text
            } else if (commandText === 'echo pacer_test') {
                printCommand(document.querySelector('.text-container'), commandText);
